...
const AddStaffingEmployee = () => {
  ...
  const validationSchema = Yup.object()
    .shape({
      // Fields that are always required regardless of ref_type
      ...
      // Fields that depend on ref_type
    ...
    .when("ref_type", {
      ...
      otherwise: Yup.object()
        ...
        .when("ref_type", {
          is: "Transfer",
          then: Yup.object().shape({
            from_company: Yup.string().required("Enter the company name"),
            from_position: Yup.string().required("Enter the position"),
          }),
          otherwise: Yup.object()
            .shape({
              from_company: Yup.string().nullable(),
            ...
            .when("ref_type", {
              ...
              then: Yup.object().shape({
                ...
                ref_contact: Yup.string().required(
                  "Enter the referrer contact number"
                ),
                ref_emp: Yup.string().required(
                  "Enter the referrer place of employment"
                ),
                ref_relation: Yup.string().required(
                  "Describe your relationship with the referrer"
                ),
              }),
            }),
        }),
