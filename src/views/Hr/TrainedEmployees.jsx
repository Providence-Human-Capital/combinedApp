...
import { areaOfSpecialization, fetchNewEmployees, fetchTrainedEmployees } from "../../services/api";
...
const TrainedEmployees = () => {
  ...
  const fetchFilteredEmployees = async (filters) => {
    try {
      setIsFetching(true);
      const response = await axios.post(`${API}/api/trained-records`, filters);
  ...
  const handleExportToExcel = () => {
    exportToExcel(exportData, "TrainedApplicants.xlsx");
  };

  const exportData2 = flattenDeployedEmployeesForReport(newEmployees);
  const handleExportAllToExcel = () => {
    exportToExcel(exportData2, "All Trained Applicants.xlsx");
  };
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-body">
                ...
                >
                  FILTER OUT TRAINED APPLICANTS INFORMATION
                </h4>
